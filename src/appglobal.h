...
#ifdef HEADLESS
// ---------------------------------------------------------------------------
// Headless mode: no GUI globals
// ---------------------------------------------------------------------------
class QObject;
class headlessController;
class headlessRxController;

extern QObject              *dispatcherPtr;   // points to headlessDispatcher
extern headlessController   *headlessCtrlPtr;
extern headlessRxController *rxWidgetPtr;     // same name, headless type

#else
// ---------------------------------------------------------------------------
// GUI mode: full widget globals
// ---------------------------------------------------------------------------
class QSplashScreen;
class scopeView;
class rxWidget;
