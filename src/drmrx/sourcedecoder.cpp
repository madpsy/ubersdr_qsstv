      ...
      if(!alreadyDisplayed)
        {
          ...
          QCoreApplication::postEvent( dispatcherPtr, stmb );
        }
              ...
              if (tbPtr->retrieveTries==0)
                {
                  ...
                  QCoreApplication::postEvent( dispatcherPtr, stmb );  // Qt will delete it when done
                  return;
                }
            }
        }
      ...
      if((tbPtr->fileName=="bsr.bin")&&(!tbPtr->alreadyReceived))
        {
          ...
          QCoreApplication::postEvent(dispatcherPtr, pe);
          return false;
        }
      baFilePtr=&ba;
    }
